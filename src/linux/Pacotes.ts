...
export const CATALOGO: Pacote[] = [
  ...
  { nome: 'coreutils', versao: '9.4-3ubuntu6', secao: 'utils', repositorio: 'main', baixarKb: 1413, instaladoKb: 7340, base: true, essencial: true,
    ...
    programas: bin('ls cp mv rm mkdir rmdir touch cat echo pwd chmod chown chgrp ln head tail wc sort cut stat whoami id groups date uname df who sleep env printenv nohup tee uniq tr du') },
  ...
  { nome: 'dash', versao: '0.5.12-6ubuntu5', secao: 'shells', repositorio: 'main', baixarKb: 91, instaladoKb: 211, base: true, essencial: true,
    descricao: 'POSIX-compliant shell', dependencias: [], arquivos: [], programas: bin('sh') },
  { nome: 'libc-bin', versao: '2.39-0ubuntu8.3', secao: 'libs', repositorio: 'main', baixarKb: 649, instaladoKb: 2780, base: true, essencial: true,
    descricao: 'GNU C Library: Binaries', dependencias: [], arquivos: [], programas: bin('getent') },
  { nome: 'findutils', versao: '4.9.0-5build1', secao: 'utils', repositorio: 'main', baixarKb: 296, instaladoKb: 1648, base: true, essencial: true,
    descricao: 'utilities for finding files--find, xargs', dependencias: [], arquivos: [], programas: bin('find xargs') },
  { nome: 'init-system-helpers', versao: '1.66ubuntu1', secao: 'admin', repositorio: 'main', baixarKb: 39, instaladoKb: 133, base: true, essencial: true,
    descricao: 'helper tools for all init systems', dependencias: [], arquivos: [], programas: bin('service', 'sbin') },
  { nome: 'tar', versao: '1.35+dfsg-3build1', secao: 'utils', repositorio: 'main', baixarKb: 253, instaladoKb: 1024, base: true, essencial: true,
    descricao: 'GNU version of the tar archiving utility', dependencias: [], arquivos: [], programas: bin('tar') },
  { nome: 'gzip', versao: '1.12-1ubuntu3', secao: 'utils', repositorio: 'main', baixarKb: 96, instaladoKb: 247, base: true, essencial: true,
    descricao: 'GNU compression utilities', dependencias: [], arquivos: [], programas: bin('gzip gunzip zcat') },
  { nome: 'sed', versao: '4.9-2build1', secao: 'utils', repositorio: 'main', baixarKb: 193, instaladoKb: 868, base: true, essencial: true,
    descricao: 'GNU stream editor for filtering/transforming text', dependencias: [], arquivos: [], programas: bin('sed') },
  { nome: 'mawk', versao: '1.3.4.20240123-1build1', secao: 'interpreters', repositorio: 'main', baixarKb: 127, instaladoKb: 252, base: true,
  ...
  { nome: 'systemd', versao: '255.4-1ubuntu8', secao: 'admin', repositorio: 'main', baixarKb: 3475, instaladoKb: 11210, base: true, essencial: true,
    descricao: 'system and service manager', dependencias: [], arquivos: [], programas: bin('systemctl journalctl') },
  ...
  { nome: 'procps', versao: '2:4.0.4-4ubuntu3', secao: 'admin', repositorio: 'main', baixarKb: 708, instaladoKb: 2156, base: true,
    descricao: '/proc file system utilities', dependencias: [], arquivos: [], programas: bin('free ps top pkill pgrep uptime kill') },
  { nome: 'util-linux', versao: '2.39.3-9ubuntu6', secao: 'utils', repositorio: 'main', baixarKb: 1128, instaladoKb: 4580, base: true, essencial: true,
    descricao: 'miscellaneous system utilities', dependencias: [], arquivos: [],
    programas: [...bin('lsblk dmesg logger blkid'), ...bin('mount umount fdisk mkfs mkfs.ext4', 'sbin')] },
  ...
  { nome: 'zip', versao: '3.0-13build1', secao: 'utils', repositorio: 'main', baixarKb: 177, instaladoKb: 546,
    descricao: 'Archiver for .zip files', dependencias: [], arquivos: [], programas: bin('zip') },
  { nome: 'unzip', versao: '6.0-28ubuntu4', secao: 'utils', repositorio: 'main', baixarKb: 174, instaladoKb: 544,
    descricao: 'De-archiver for .zip files', dependencias: [], arquivos: [], programas: bin('unzip') },
